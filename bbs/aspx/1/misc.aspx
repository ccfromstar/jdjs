...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2009/9/29 9:12:39.
		本页面代码由Discuz!NT模板引擎生成于 2009/9/29 9:12:39. 
	*/
	...
	templateBuilder.Append("	    <div class=\"float\" id=\"floatlayout_topicadmin\" style=\"height: 380px;\">\r\n");
	templateBuilder.Append("            <div class=\"floatboxnarrow\">\r\n");
	templateBuilder.Append("                <h3 class=\"float_ctrl\">\r\n");
	templateBuilder.Append("                    <em id=\"return_emailfriend\">分享</em>\r\n");
	templateBuilder.Append("                    <span><a href=\"javascript:;\" class=\"float_close\" onclick=\"floatwin('close_emailfriend')\" title=\"关闭\">关闭</a></span>\r\n");
	...
	templateBuilder.Append("                            <td><h5>通过 QQ、MSN 分享给朋友</h5></td>\r\n");
	templateBuilder.Append("                        </tr>\r\n");
	templateBuilder.Append("                        <tr>\r\n");
	templateBuilder.Append("                            <td>\r\n");
	templateBuilder.Append("                                <input onclick=\"submithandle_emailfriend();setcopy(window.location.toString().replace(/#(.*?)$/ig, ''), '帖子地址已经复制到剪贴板，您可以用快捷键 Ctrl + V 粘贴到 QQ、MSN 里。')\" type=\"button\" value=\"复制本帖链接\" />\r\n");
	templateBuilder.Append("                            </td>\r\n");
	templateBuilder.Append("                        </tr>\r\n");
	...
	templateBuilder.Append("                        <table cellspacing=\"0\" cellpadding=\"2\">\r\n");
	templateBuilder.Append("                            <tr>\r\n");
	templateBuilder.Append("                                <td><h5>通过 Email 分享给朋友</h5></td>\r\n");
	templateBuilder.Append("                            </tr>\r\n");
	templateBuilder.Append("                            <tr>\r\n");
	templateBuilder.Append("                                <td>\r\n");
	...
	templateBuilder.Append("                                    <input name=\"sendsubmit\" type=\"submit\" value=\"发送\" />\r\n");
	templateBuilder.Append("                                </td>\r\n");
	templateBuilder.Append("                            </tr>\r\n");
	templateBuilder.Append("                        </table>\r\n");
	templateBuilder.Append("                    </form>\r\n");
	templateBuilder.Append("                    <hr class=\"shadowline\" />\r\n");
	templateBuilder.Append("                    <h5><a href=\"javascript:;\" onclick=\"submithandle_emailfriend();floatwin('open_postpm', 'usercppostpm.aspx?tid=");
	templateBuilder.Append(tid.ToString());
	templateBuilder.Append("&operation=pmfriend', 600, 410);\">通过站内短消息分享给朋友</a></h5>\r\n");
	...
	templateBuilder.Append("        function submithandle_emailfriend(locationhref)\r\n");
	templateBuilder.Append("        {\r\n");
	templateBuilder.Append("            floatwinreset = 1;\r\n");
	templateBuilder.Append("            floatwin('close_emailfriend');\r\n");
	templateBuilder.Append("        }\r\n");
	templateBuilder.Append("        var lastsel = $('itemcp_im');\r\n");
	templateBuilder.Append("        function switchitemcp(id)\r\n");
	templateBuilder.Append("        {\r\n");
	templateBuilder.Append("            if (lastsel)\r\n");
	templateBuilder.Append("            {\r\n");
	templateBuilder.Append("                lastsel.className = '';\r\n");
	templateBuilder.Append("            }\r\n");
	templateBuilder.Append("            $(id).className = 'currentopt';\r\n");
	templateBuilder.Append("            lastsel = $(id);\r\n");
	templateBuilder.Append("        }\r\n");
	templateBuilder.Append("    </");
	templateBuilder.Append("script>\r\n");
	...
	templateBuilder.Append("	        <h3 class=\"float_ctrl\">\r\n");
	templateBuilder.Append("	            <em id=\"Em1\">分享</em>\r\n");
	templateBuilder.Append("		        <span><a href=\"javascript:;\" class=\"float_close\" onclick=\"floatwin('close_emailfriend')\" title=\"关闭\">关闭</a></span>\r\n");
	templateBuilder.Append("	        </h3>\r\n");
