...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2009/9/29 9:13:05.
		本页面代码由Discuz!NT模板引擎生成于 2009/9/29 9:13:05. 
	*/
	...
	templateBuilder.Append("var postaction='editpost.aspx?infloat=1&postid=");
	templateBuilder.Append(postinfo.Pid.ToString().Trim());
	...
	templateBuilder.Append("function closeedit()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("		if($('floatwin_edit'))\r\n");
	templateBuilder.Append("        $('floatwin_edit').parentNode.removeChild($('floatwin_edit')); \r\n");
	templateBuilder.Append("		if($('floatwin_edit_mask'))\r\n");
	templateBuilder.Append("		 $('floatwin_edit_mask').parentNode.removeChild($('floatwin_edit_mask'));\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("</");
	templateBuilder.Append("script>\r\n");
	...
	templateBuilder.Append("	<div id=\"floatlayout_edit\" class=\"float\" \r\n");

	if (infloat==1)
	{

	templateBuilder.Append("style=\"width: 600px; height: 410px;\"\r\n");
	...
	templateBuilder.Append("    <form method=\"post\" name=\"postform\" id=\"postform\" action=\"editpost.aspx?infloat=1&postid=");
	templateBuilder.Append(postinfo.Pid.ToString().Trim());
	templateBuilder.Append("&topicid=");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	...
	templateBuilder.Append("		<div class=\"specialinfo sppoll\"  id=\"divPoll\">\r\n");
	...
	templateBuilder.Append("					<input type=\"text\" class=\"txt left\" style=\"margin-right:2px\" size=\"2\" name=\"displayorder\" maxlength=\"4\" value=\"" + poll["displayorder"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("					<input type=\"text\" name=\"pollitemid\" value=\"" + poll["name"].ToString().Trim() + "\" class=\"optioninfo txt\" />\r\n");
	templateBuilder.Append("					<a href=\"javascript:;\" class=\"deloption\" title=\"删除投票项\" onclick=\"if(!delObj(document.getElementById('polloptions'),2)){alert('投票项不能少于2个');}\">del</a>\r\n");
	templateBuilder.Append("				</p>\r\n");
	...
	templateBuilder.Append(config.Maxpolloptions.ToString().Trim());
	templateBuilder.Append("')\" href=\"javascript:;\">+增加投票项</a> \r\n");
	templateBuilder.Append("			<a onclick=\"if(!delObj(document.getElementById('polloptions'), (is_ie ? 2 : 4))){alert('投票项不能少于2个');}\" href=\"javascript:;\">删除投票项</a>\r\n");
	templateBuilder.Append("			</p>\r\n");
	templateBuilder.Append("		</div>\r\n");
	...
	templateBuilder.Append("\" class=\"spshortinput txt\" name=\"maxchoices\"/></span>\r\n");
	templateBuilder.Append("			</p>\r\n");
	templateBuilder.Append("			<p>\r\n");
	...
	templateBuilder.Append("				<dd><input name=\"topicprice\" type=\"text\" class=\"txt\" id=\"topicprice\" value=\"");
	templateBuilder.Append(topic.Price.ToString().Trim());
	...
	templateBuilder.Append("		<h3 class=\"float_ctrl\">\r\n");
	templateBuilder.Append("			<span>\r\n");
	templateBuilder.Append("				<a href=\"javascript:;\" class=\"float_close\" onclick=\"floatwin('floatwin_edit');\" title=\"关闭\">关闭</a>\r\n");
	templateBuilder.Append("			</span>\r\n");
	templateBuilder.Append("		</h3>\r\n");
