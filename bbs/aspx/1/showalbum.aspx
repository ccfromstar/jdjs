...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2009/9/29 9:12:57.
		本页面代码由Discuz!NT模板引擎生成于 2009/9/29 9:12:57. 
	*/
	...
	templateBuilder.Append("		</cite>\r\n");
	templateBuilder.Append("		<h2 style=\"line-height:36px;height:36px;\">");
	templateBuilder.Append(album.Title.ToString().Trim());
	...
	templateBuilder.Append("			<label for=\"password\">请输入密码:</label><input name=\"albumpassword\" type=\"password\" id=\"albumpassword\" size=\"20\"/>\r\n");
