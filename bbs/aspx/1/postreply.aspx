...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&';\r\n");
	templateBuilder.Append("function closereply()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("		if($('floatwin_reply'))\r\n");
	templateBuilder.Append("        $('floatwin_reply').parentNode.removeChild($('floatwin_reply')); \r\n");
	templateBuilder.Append("		if($('floatwin_reply_mask'))\r\n");
	templateBuilder.Append("		 $('floatwin_reply_mask').parentNode.removeChild($('floatwin_reply_mask'));\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("</");
	templateBuilder.Append("script>\r\n");
	...
	templateBuilder.Append("	</");
	templateBuilder.Append("script>\r\n");
	templateBuilder.Append("	<div id=\"floatlayout_reply\" class=\"float\" \r\n");
	...
	templateBuilder.Append("			<div class=\"postbox\" id=\"realmoreinfo\" style=\"display: none;\" style=\"margin:0;margin-bottom:10px;\">\r\n");
	templateBuilder.Append("					<div id=\"newpost\" class=\"post\">					\r\n");
	templateBuilder.Append("						<p><input name=\"continuereply\" type=\"checkbox\" \r\n");
	...
	templateBuilder.Append("	<h3 class=\"float_ctrl\">\r\n");
	templateBuilder.Append("		<span>\r\n");
	templateBuilder.Append("			<a href=\"javascript:;\" class=\"float_close\" onclick=\"floatwin('floatwin_reply');\" title=\"关闭\">关闭</a>\r\n");
	templateBuilder.Append("		</span>\r\n");
	templateBuilder.Append("	</h3>\r\n");
