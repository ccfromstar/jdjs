...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("><a href=\"usercpsubscribe.aspx?typeid=0\"><span>收藏的主题</span></a></li>\r\n");
	...
	templateBuilder.Append("><a href=\"usercpsubscribe.aspx?typeid=1\"><span>收藏的");
	templateBuilder.Append(config.Albumname.ToString().Trim());
	...
	templateBuilder.Append("><a href=\"usercpsubscribe.aspx?typeid=2\"><span>收藏的日志</span></a></li>\r\n");
	...
	templateBuilder.Append("><a href=\"usercpsubscribe.aspx?typeid=3\"><span>收藏的商品</span></a></li>\r\n");
	...
	templateBuilder.Append("		<form id=\"favlist\" name=\"favlist\" method=\"post\" action=\"\" class=\"datalist\">\r\n");
	...
	templateBuilder.Append("				<td width=\"55%\" style=\"text-align: left;\">标题</td>\r\n");
	templateBuilder.Append("				<td width=\"15%\">作者</td>\r\n");
	...
	templateBuilder.Append("			<tr>\r\n");
	templateBuilder.Append("			<td><input name=\"titemid\" id=\"id" + favorites["tid"].ToString().Trim() + "\" type=\"checkbox\"  id=\"Checkbox1\"  value=\"" + favorites["tid"].ToString().Trim() + "\"/></td>\r\n");
	...
	templateBuilder.Append("\">" + favorites["title"].ToString().Trim() + "</a>\r\n");
	...
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td class=\"time\">" + favorites["postdatetime"].ToString().Trim() + "</td>\r\n");
