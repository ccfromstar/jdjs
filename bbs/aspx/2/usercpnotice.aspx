...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2010/6/12 9:36:02.
		本页面代码由Discuz!NT模板引擎生成于 2010/6/12 9:36:02. 
	*/
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"javascript/template_usercpnotice.js\"></");
	templateBuilder.Append("script>\r\n");
	...
	if (filter=="goodstrade")
	{

	templateBuilder.Append("商品交易\r\n");

	}	//end if


	if (filter=="goodsleaveword")
	{

	templateBuilder.Append("商品留言\r\n");
	...
	templateBuilder.Append("				<table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" class=\"pm_list\">\r\n");
	...
	templateBuilder.Append("						<td class=\"notice_list\">\r\n");

	if (noticeinfo.New==1)
	{

	templateBuilder.Append("								");
	templateBuilder.Append(noticeinfo.Note.ToString().Trim());
	templateBuilder.Append("\r\n");
	...
	templateBuilder.Append(noticeinfo.Postdatetime.ToString().Trim());
	templateBuilder.Append("'));</");
