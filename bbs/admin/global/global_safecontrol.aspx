                    ...
                    <td class="panelbox" colspan="2">
                        <table width="100%">
                            <tr>
                                ...
                                <td class="td1">
                                    <cc1:DropDownList ID="VerifyImage" runat="server">
                                    </cc1:DropDownList>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                ...
                                <td style="width: 200px">
                                    <cc1:TextBox ID="seccodestatus" runat="server" HintShowType="down" CssClass="" RequiredFieldType="暂无校验"
                                        TextMode="MultiLine" Height="90px" Rows="4" Cols="30" HintInfo="请选取相应的页面复选框, 并在相应页面模板表单中加入{_vcode}校验码子模板, 就可以增加校验码判断功能."
                                        HintTitle="提示">
                                    </cc1:TextBox>&nbsp;
                                </td>
                                    ...
                                    <table id="seccodestatus_select">
                                        <tr>
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_0" type="checkbox" name="seccodestatus_select:0"
                                                    onclick="checkselecedpage()" value="register" />
                                                <label for="seccodestatus_select_0">
                                                    新用户注册</label>
                                            </td>
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_5" type="checkbox" name="seccodestatus_select:5"
                                                    onclick="setstatus(this);" value="showforum" />
                                                <label for="seccodestatus_select_5">
                                                    查看(已设置密码)版块</label>
                                            </td>
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_1" type="checkbox" name="seccodestatus_select:1"
                                                    onclick="checkselecedpage();" value="login" />
                                                <label for="seccodestatus_select_1">
                                                    用户登录</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_6" type="checkbox" name="seccodestatus_select:6"
                                                    onclick="setstatus(this)" value="showtopic" />
                                                <label for="seccodestatus_select_6">
                                                    快速回复(主题页)</label>
                                            </td>
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_2" type="checkbox" name="seccodestatus_select:2"
                                                    onclick="setstatus(this);" value="posttopic" />
                                                <label for="seccodestatus_select_2">
                                                    发表主题</label>
                                            </td>
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_7" type="checkbox" name="seccodestatus_select:7"
                                                    onclick="checkselecedpage()" value="usercpprofile" />
                                                <label for="seccodestatus_select_7">
                                                    修改个人密码</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_3" type="checkbox" name="seccodestatus_select:3"
                                                    onclick="checkselecedpage()" value="postreply" />
                                                <label for="seccodestatus_select_3">
                                                    发表回复</label>
                                            </td>
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_8" type="checkbox" name="seccodestatus_select:8"
                                                    onclick="checkselecedpage()" value="editpost" />
                                                <label for="seccodestatus_select_8">
                                                    修改帖子</label>
                                            </td>
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_4" type="checkbox" name="seccodestatus_select:4"
                                                    onclick="checkselecedpage()" value="usercppostpm" />
                                                <label for="seccodestatus_select_4">
                                                    发送短消息</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_9" type="checkbox" name="seccodestatus_select:9"
                                                    onclick="checkselecedpage()" value="editgoods" />
                                                <label for="seccodestatus_select_9">
                                                    编辑商品</label>
                                            </td>
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_10" type="checkbox" name="seccodestatus_select:10"
                                                    onclick="checkselecedpage()" value="showgoods" />
                                                <label for="seccodestatus_select_10">
                                                    显示商品</label>
                                            </td>
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_11" type="checkbox" name="seccodestatus_select:11"
                                                    onclick="checkselecedpage()" value="postgoods" />
                                                <label for="seccodestatus_select_11">
                                                    发送商品</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 0px">
                                                <input id="seccodestatus_select_12" type="checkbox" name="seccodestatus_select:12" onclick="setstatus(this);"
                                                    value="quicklyposttpoic" />
                                                <label for="seccodestatus_select_12">
                                                    首页快速发帖</label>
                                            </td>
                                            <td>
                                            </td>
                    ...
                    <td class="panelbox" width="50%" align="left">
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    <cc1:TextBox SetFocusButtonID="SaveInfo" ID="maxonlines" runat="server" HintInfo="请设置合理的数值, 范围 10~65535, 建议设置为平均在线人数的 10 倍左右"
                                        HintTitle="提示" RequiredFieldType="数据校验" CanBeNull="必填" Text="9000" MaxLength="5"
                                        Size="6" MinimumValue="10" MaximumValue="65535">
                                    </cc1:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="td2">
                                    <cc1:TextBox SetFocusButtonID="SaveInfo" ID="searchctrl" runat="server" HintInfo="两次搜索间隔小于此时间将被禁止, 0 为不限制"
                            ...
                            <tr>
                                ...
                                <td>
                                    <cc1:RadioButtonList ID="secques" runat="server" RepeatLayout="flow" HintInfo="用户登录时是否启用安全问题"
                                        HintTitle="提示">
                            ...
                            <tr>
                                ...
                                <td>
                                    <cc1:TextBox SetFocusButtonID="SaveInfo" ID="postinterval" runat="server" HintInfo="两次发帖间隔小于此时间, 或两次发送短消息间隔小于此时间的二倍将被禁止, 0 为不限制"
                            ...
                            <tr>
                                ...
                                <td>
                                    <cc1:TextBox SetFocusButtonID="SaveInfo" ID="maxspm" runat="server" HintInfo="论坛系统每 60 秒系统响应的最大搜索次数, 0 为不限制. 注意: 如果服务器负担较重, 建议设置为 5, 或在 5~20 范围内取值, 以避免过于频繁的搜索造成数据表被锁"
                            ...
                            <tr>
                                ...
                                <td>
                                    <cc1:RadioButtonList ID="admintools" runat="server" RepeatColumns="1" RepeatLayout="flow"
                                        HintTitle="提示" HintInfo="是否使用管理员客户端工具" HintPosOffSet="180">
