...
<html>
	...
	<body>
		...
		<table cellspacing="0" cellpadding="4" width="100%" align="center">
			...
			<tr>
				<td colspan="3">
				<a class="ManagerButton" onclick="javascript:window.open('http://nt.discuz.net/whatsnew/index.aspx?ver=<%=Utils.GetAssemblyVersion()%>&dbtype=0','','');" ><strong>检测官方最新版本</strong></a>
