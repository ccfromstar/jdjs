                    ...
                    <td  class="panelbox" align="left" width="50%">
                        <table width="100%">
                            ...
                            <tr>
					            <td>本版块SEO关键词:</td>
					            <td>
						            <cc2:textbox id="seokeywords" runat="server" HintTitle="提示" HintInfo="设置本版块的SEO关键词,用于搜索引擎优化,放在meta的keyword标签中,多个关键字间请用半角逗号&amp;quot,&amp;quot隔开" RequiredFieldType="暂无校验" width="250" height="100" 
                            ...
                            <tr>
					            <td>本版块URL重写:</td>
					            <td>
						            <cc2:textbox id="rewritename" runat="server" Width="250px" RequiredFieldType="暂无校验" IsReplaceInvertedComma="false"  MaxLength="20" HintInfo="设置版块URL重写,以字母开头,其后可以是字母或数字,但不可包含<br>&amp;quot;install,upgrade,admin,aspx,tools,archive,space&amp;quot;中任意一个字符串"></cc2:textbox>
					            </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table width="100%">                            
					        ...
					        <tr>
		       		        ...
		       		        <tr>
					            <td>本版块SEO说明:</td>
					            <td>
						            <cc2:textbox id="seodescription" runat="server" HintTitle="提示" HintInfo="设置本版块的SEO说明,用于搜索引擎优化,放在meta的description标签中,多个说明文字间请用半角逗号&amp;quot,&amp;quot隔开" RequiredFieldType="暂无校验" width="250" height="100" 
						            TextMode="MultiLine" IsReplaceInvertedComma="false"></cc2:textbox>
					            </td>
                            </tr>
                        </table>
