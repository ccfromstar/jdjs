			...
			<table class="table1" cellspacing="0" cellpadding="4" width="100%">
				<tr>
					...
					<td style="width: 100px">
                        ...
                        RequiredFieldType="数据校验" Text="30" Size="5"/>天前
                    </td>
                  <td><cc1:Button id="DeleteRecycle" runat="server" Text=" 批量清空回收站 " OnClick="DeleteRecycle_Click" OnClientClick="if(!confirm('你确认要删除指定天数的帖子吗？')) return false;"></cc1:Button></td>
				</tr>
		  </table>
		</fieldset>
		</div>	
