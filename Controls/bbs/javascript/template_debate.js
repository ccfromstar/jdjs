...
function showDebatReplyBox(tid, pid, opinion, parseurloff, smileyoff, bbcodeoff, processtime, olid)
{
	...
	html += '		<tr>';
	html += '			<td>';
	html += '		<textarea name="message" cols="40" rows="7" class="txtarea autosave"  tabindex="2" onkeydown="debatequickreply(event, this.form);"  onfocus='; 
