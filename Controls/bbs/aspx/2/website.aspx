...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\" target=\"_blank\">\r\n");
	templateBuilder.Append(Utils.GetUnicodeSubString(views_topicinfo["title"].ToString().Trim(),24,""));
	templateBuilder.Append("</a>\r\n");
	templateBuilder.Append("           </li>            \r\n");
	...
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\" target=\"_blank\">\r\n");
	templateBuilder.Append(Utils.GetUnicodeSubString(digest_topicinfo["title"].ToString().Trim(),24,""));
	templateBuilder.Append("</a>\r\n");
	templateBuilder.Append("           </li>            \r\n");
