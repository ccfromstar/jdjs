...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("			<span onmouseover=\"if($('newspecial_menu').childNodes.length>0)  showMenu(this.id);\" id=\"newspecial\" class=\"postbtn\"><a title=\"发新话题\" id=\"newtopic\" href=\"");
	templateBuilder.Append(forumpath.ToString());
...
/*特殊帖图标*/
	...
	templateBuilder.Append("			<strong>在线用户</strong>- <em>");
	...
	templateBuilder.Append("templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/images/noavatar_small.gif';\"  alt=\"头像\" id=\"memberinfo_" + onlineuser__loop__id.ToString() + "\" onmouseover=\"showauthor(this,");
	templateBuilder.Append(onlineuser.Userid.ToString().Trim());
	templateBuilder.Append("" + onlineuser__loop__id.ToString() + ")\" class=\"left\" style=\"margin-right:10px;vertical-align:center;\"/>\r\n");
