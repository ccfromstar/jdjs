...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("	<h1>管理图片</h1>\r\n");
	...
	templateBuilder.Append("		<li>\r\n");
	templateBuilder.Append("			<div class=\"photo_img\">\r\n");
	templateBuilder.Append("			<a href='showphoto.aspx?photoid=" + singlePhotoInfo["photoid"].ToString().Trim() + "' target='_blank'>\r\n");
	templateBuilder.Append("			<img src='" + singlePhotoInfo["TFileName"].ToString().Trim() + "' border='0' title='" + singlePhotoInfo["Description"].ToString().Trim() + "' style=\"max-width: 150px; max-height: 150px;\"></a>\r\n");
	...
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("			<div class=\"phtot_detail\">\r\n");
	...
	templateBuilder.Append("			时间：" + singlePhotoInfo["PostDate"].ToString().Trim() + "\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("		</li>\r\n");
	...
	templateBuilder.Append("		<div class=\"zerothreads\">暂无图片</div>\r\n");
	...
	templateBuilder.Append("			<a href=\"###\" onclick=\"return delePhoto($('photolist'))\">删除图片</a>&nbsp;&nbsp;\r\n");
	...
	templateBuilder.Append(currentalbumname.ToString());
	templateBuilder.Append("';\r\n");
	templateBuilder.Append("		if (confirm(\"您确认要将 \" + o.options[o.selectedIndex].text + \" 图片设置为当前相册\\\"\" + currentablumname + \"\\\"的封面吗？\"))\r\n");
	templateBuilder.Append("		{\r\n");
