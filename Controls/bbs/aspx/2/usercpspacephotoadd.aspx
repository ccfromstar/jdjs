...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2010/6/12 9:35:59.
		本页面代码由Discuz!NT模板引擎生成于 2010/6/12 9:35:59. 
	*/
	...
	templateBuilder.Append("	</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<img id=\"img_hidden\" style=\"position:absolute;top:-100000px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod='image');width:400;height:300\"></img>\r\n");
	...
	templateBuilder.Append("	<h1>增加图片</h1>\r\n");
	...
	templateBuilder.Append("	<table id=\"tab");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\" cellspacing=\"0\" cellpadding=\"0\" class=\"formtable\" summary=\"增加图片");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\" \r\n");
	...
	templateBuilder.Append("			<th><label for=\"phototitle");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\">标题</label></th>\r\n");
	templateBuilder.Append("			<td><input name=\"phototitle");
	templateBuilder.Append(num.ToString());
	...
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("			<th><label for=\"description");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\">描述</label></th>\r\n");
	templateBuilder.Append("			<td><textarea name=\"description");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\" rows=\"4\" class=\"txtarea\" cols=\"50\"></textarea></td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	...
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("			<th><label for=\"phototag");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\">标签</label></th>\r\n");
	templateBuilder.Append("			<td><input name=\"phototag");
	templateBuilder.Append(num.ToString());
	...
	templateBuilder.Append("			<td><span id=\"td");
	templateBuilder.Append(num.ToString());
	...
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("			<th><label for=\"photo");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\">选择图片</label></th>\r\n");
	templateBuilder.Append("			<td>\r\n");
	templateBuilder.Append("				<input type=\"file\" id=\"photo");
	templateBuilder.Append(num.ToString());
	...
	templateBuilder.Append("	<div style=\"padding-top:10px; padding-left:150px;\">\r\n");
