...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("	<h1>会员列表</h1>\r\n");
	...
	templateBuilder.Append("			<td class=\"time\">" + user["joindate"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td class=\"time\">" + user["lastactivity"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		</tbody>\r\n");
