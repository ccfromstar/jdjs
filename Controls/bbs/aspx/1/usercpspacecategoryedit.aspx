...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("		<h1>编辑日志分类</h1>\r\n");
	...
	templateBuilder.Append("					<th><label for=\"user\">分类名称</label></th>\r\n");
	templateBuilder.Append("					<td><input name=\"title\" type=\"text\" id=\"title\" value=\"");
	templateBuilder.Append(spacecategoryinfo.Title.ToString().Trim());
	templateBuilder.Append("\" size=\"40\" maxlength=\"50\" class=\"txt\"/></td>\r\n");
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("					<th><label for=\"email\">分类描述</label></th>\r\n");
	templateBuilder.Append("					<td><textarea name=\"description\" cols=\"50\" rows=\"6\" id=\"categorydescription\" class=\"txtarea\">");
	templateBuilder.Append(spacecategoryinfo.Description.ToString().Trim());
	templateBuilder.Append("</textarea></td>\r\n");
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("					<th><label for=\"comment\">分类序号</label></th>\r\n");
	templateBuilder.Append("					<td><input name=\"displayorder\" type=\"text\" id=\"displayorder\" value=\"");
