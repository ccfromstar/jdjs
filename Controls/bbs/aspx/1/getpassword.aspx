...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<div class=\"wrap s_clear\" id=\"wrap\">\r\n");
	templateBuilder.Append("<div class=\"main\">\r\n");
	templateBuilder.Append("<h1>找回密码</h1>\r\n");
	templateBuilder.Append("<form id=\"form1\" name=\"form1\" method=\"post\" action=\"getpassword.aspx#\">\r\n");
	templateBuilder.Append("	<table cellspacing=\"0\" cellpadding=\"0\" class=\"formtable\" summary=\"密码找回\">\r\n");
	templateBuilder.Append("	<tbody>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("			<th><label for=\"username\">用户名</label></th>\r\n");
	templateBuilder.Append("			<td><input name=\"username\" type=\"text\" id=\"username\" size=\"25\" value=\"");
	templateBuilder.Append(username.ToString());
	templateBuilder.Append("\" class=\"txt\" /></td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("			<th><label for=\"email\">EMail</label></th>\r\n");
	templateBuilder.Append("			<td><input name=\"email\" type=\"text\" id=\"email\" size=\"25\" class=\"txt\" /></td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	...
	templateBuilder.Append("			<td>\r\n");
	templateBuilder.Append("				<button name=\"login\" type=\"submit\" id=\"login\" onclick=\"javascript:location.replace('?agree=yes')\" />取回密码</button>\r\n");
