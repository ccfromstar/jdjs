                    ...
                    <td class="panelbox">
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    <cc1:TextBox ID="subject" runat="server" CanBeNull="必填" RequiredFieldType="暂无校验"
                    ...
                    <td class="panelbox">
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    <cc1:TextBox ID="msgfrom" runat="server" CanBeNull="必填" RequiredFieldType="暂无校验">
                                    </cc1:TextBox>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td class="panelbox">
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    <cc1:TextBox ID="postdatetime" runat="server" CanBeNull="必填" RequiredFieldType="日期"
                                        Size="10">
                                    </cc1:TextBox>格式:2005-5-5
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td class="panelbox">
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    <cc1:TextBox ID="postcountpercircle" runat="server" CanBeNull="必填" RequiredFieldType="数据校验"
                                        Size="10">100
                                    </cc1:TextBox>
                                </td>
                            </tr>
