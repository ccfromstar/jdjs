		...
		<table cellspacing="0" cellpadding="4" width="100%" align="center">
            <tr>
                <td class="panelbox" width="50%" align="left">
                    <table width="100%">
                        <tr>
		                    <td style="width: 120px">应用程序名称:</td>
                    ...
                    <table width="100%" id="showurl" runat="server">
                        <tr>
		                    <td style="width: 120px">应用程序 Url 地址:</td>
		                    <td><cc1:TextBox id="appurl" runat="server" HintInfo="应用程序的首页地址" Width="250"></cc1:TextBox></td>
                        </tr>
                        <tr>
		                    <td>登录完成后返回地址:</td>
		                    <td><cc1:TextBox id="callbackurl" runat="server" HintInfo="通过通行证登录以后返回应用程序的地址(Callback URL)" CanBeNull="必填" Width="250"></cc1:TextBox></td>
                        </tr>
                    </table>
                </td>
            </tr>
