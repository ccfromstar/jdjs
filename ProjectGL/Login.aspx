<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="JDJS.Web.ProjectGL.Login" %>
...
<body>
    ...
    <div class="loginbar">
        <table style="width: 100%; ">
            ...
            <tr>
                <td colspan="8" align="center">版本：V 1.0
                </td>
            </tr>
            </table>
    </div>
    <div  style=" text-align:center;"><br/>“建定工程通”简称“建定通”是一款涵盖江浙沪地区所有建设工程信息及相关工程人脉的信息资讯类web产品。
    <br/><br/>如需了解产品详情请联系：54591008-8009 叶小姐 客服QQ：1003264094
    </div>
    </div>
    </form>
</body>
