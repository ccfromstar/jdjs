<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ProjectList.aspx.cs" Inherits="JDJS.Web.ProjectList" %>
...
<div class="SubTop">
        <table style="width: 624px;">
            ...
            <tr>
                ...
                <td align=center> <asp:Button ID="btnSeach" runat="server" Text="搜索" onclick="btnSeach_Click" 
    ...
    <div class="SubCenter">
       <asp:Image ID="ImgBg" runat="server" /><div class="subbody">
            <ul class="subbdul">
                ...
                <ItemTemplate>
                    <li><span>[<%#Eval("发布日期", "{0:yyyy-MM-dd}")%>]</span><a href="ProjectDetail.aspx?Part=<%=Part%>&Id=<%#Eval("序号") %>" title="<%#Eval("项目名称") %>"><%#LTP.Common.StringPlus.StrCut(Eval("项目名称").ToString(), 82, "...")%></a><%#NewStr(Eval("发布日期", "{0:yyyy-MM-dd}").ToString())%></li>
                </ItemTemplate>
                </asp:Repeater>
            </ul>
       </div>
