...
{
    public partial class dsMasterPage : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            //JDJS.BLL.ds_data bll = new JDJS.BLL.ds_data();
            //JDJS.Model.ds_data model = bll.GetModel(Page.Header.Title.ToString());
            //Page.Header.Title = model.HtmlTitle;
        }
        public string Settitle(string cid)
        {
            string PicURL;
