...
namespace JDJS.Web
{
    public partial class WXProMatDetail : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["AdminInfo"] != null)
            {
                ...
                HSlogined.Visible = true;
                NOlogined.Visible = false;
            }
            else
            {
                HSlogined.Visible = false;
                NOlogined.Visible = true;
        ...
        private void BindInfo(int Id)
        {
            ...
            proname.NavigateUrl = "WXProDetail.aspx?id=" + model.proid.ToString();
            ...
            linkman.NavigateUrl = "WXContactinfo.aspx?id=" + model.pepid.ToString();

            Lcompany.Text = model.company;
            Lcompany.NavigateUrl = "WXcompany.aspx?id=" + model.pcid.ToString();
