<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="JDJS.Web.WebManager.Edit" %>
        ...
        <table  width="100%" cellpadding="2" cellspacing="0">
         ...
         <tr>
            ...
            <table width="100%" cellpadding="2" cellspacing="0" class="dataTable">
             ...
             <asp:Panel ID="PanelSQ" runat="server" Visible="false">
            <table width="100%" cellpadding="2" cellspacing="0" class="dataTable">
                <tr class="dataTableHead">
                    <td >
                        合作优惠项目申请详情
                ...
                <td>
                    ...
                    <td >
                       ...
                       <tr>
                            ...
                            <td><asp:Label ID="LabDBtitle" runat="server" Text="Label"></asp:Label></td>
                        </tr>
                       <tr>
                            <td style=" width:110px">
                                <b>项目内容列表： </b>
                         ...
                         <tr style=" background:#000000; font-weight:bold;" >
                            <td height="30" align="center" style="color:#ffffff;">项目名称</td>
                            <td style=" width:100px;color:#ffffff;" align="center" >项目内容</td>
                            <td style=" width:100px;color:#ffffff;" align="center" >金额</td>
                    
                        </tr> 
                        <tr>
                            <asp:Repeater ID="RepDiscountDetail" runat="server">
                            <ItemTemplate>
                            <tr class="dataTable">
                    
                                <td><%#LTP.Common.StringPlus.StrCut(Eval("det_title").ToString(), 82, "...")%></td>
                                <td><%#LTP.Common.StringPlus.StrCut(Eval("det_rek").ToString(), 82, "...")%></td>
                              
                                <td><%#LTP.Common.StringPlus.StrCut(Eval("Dis_monry").ToString(), 30, "...")%></td>
                        ...
                        <tr>
                            ...
                            <td><asp:Label ID="LabSQcompany" runat="server" Text="Label"></asp:Label></td>
                        </tr>
                        <tr>
                            <td style=" width:70px" align=right>
                            申请人：
                            </td>
                            <td><asp:Label ID="LabSQlinkman" runat="server" Text="Label"></asp:Label></td>
                        </tr>
                        <tr>
                            <td style=" width:70px" align=right>
                            申请时间：
                            </td>
                            <td><asp:Label ID="LabSQtime" runat="server" Text="Label"></asp:Label></td>
                        </tr>
                        <tr>
                            <td style=" width:70px" align=right>
                            付款时间：
                            </td>
                           <td><asp:Label ID="Labpaytime" runat="server" Text="Label"></asp:Label></td>
                        </tr>
                        <tr>
                            <td style=" width:70px" align=right>
                            总金额：
                            </td>
                            <td><asp:Label ID="LabSQamount" runat="server" Text="Label"></asp:Label></td>
                        </tr>
                        <tr>
                            <td style=" width:110px; font-weight: 700;">
                            申请内容列表：
                            </td>
                           
                        </tr>
                        <tr style=" background:#003399; font-weight:bold;" >
                            <td height="30" align="center" style="color:#ffffff;">申请项目名称</td>
                            <td style=" width:100px;color:#ffffff;" align="center">申请项目内容</td>
                            <td style=" width:100px;color:#ffffff;" align="center">申请金额</td>
                    
                        </tr> 
                       <tr>
                            <asp:Repeater ID="RepSQDetail" runat="server">
                            <ItemTemplate>
                            <tr class="dataTable">
                        ...
                        <tr>
                            <td align=right>
                                &nbsp;</td>
                            <td>
                                   <a href="javascript:history.back(-1)" class="stylelink">[返回上页]</a></td>
                        </tr>
                       ...
                       <tr>
                        ...
                        <tr>
                            <td align=right>
                                &nbsp;</td>
                            <td>
                                    <asp:LinkButton ID="LinkButton6" CssClass="zPushBtn" runat="server" onclick="LinkButton6_Click" 
                                        >
                                <img height="20" src="style/Icons/icon039a16.gif" width="20" /><b>提交&nbsp;</b></asp:LinkButton></td>
                        </tr>
                        ...
                        <td align=right>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox76" runat="server" 
                                    Width="200px" ></asp:TextBox>（“0”显示供应商信息，“1”人工询价）
                            </td>
                        </tr>
                        <tr>
                            <td align=right>
