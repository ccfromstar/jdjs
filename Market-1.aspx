...
<%--       <div class="subfoot"></div>--%>
    ...
    <div class="SubCenter">
       ...
       <div class="subbody">
        <table style="width:627px;border-collapse:collapse; color:#003399;" border="1" cellpadding="0" cellspacing="0" bordercolor="#3366cc"   >   
        <tr style=" background:#003399; color:#ffffff; font-weight:bold;" >
            <td width=160 height=30 align=center>名称</td>
            <td width=85 align=center>规格</td>
            <td width=80 align=center>材质</td>
            <td width=80 align=center>出厂价</td>
            <td width=80 align=center>成交价</td>
            <td width=60 align=center>成交量</td>
            <td width=80 align=center>材料编码</td>
<%--            <td width=70 align=center>发布时间</td>--%>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align=center><%#Eval("Factory", "{0:c}")%></td>
                <td style="font-size:14px;" align=center><%#Eval("Bid", "{0:c}")%></td>
                <td align=center><%#Eval("Volume")%></td>
                <td align=center><%#Eval("seachid")%></td>
