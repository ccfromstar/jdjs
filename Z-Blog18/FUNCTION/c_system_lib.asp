...
Class TArticle
	...
	Public Function LoadInfobyID(log_ID)
		...
		If (Not objRS.bof) And (Not objRS.eof) Then
			...
			Content=TransferHTML(Content,"[upload]")
			Intro=TransferHTML(Intro,"[upload]")
