...
If (Not objRS.bof) And (Not objRS.eof) Then
	Do While Not objRS.eof
		...
		strTagCloud(j) = "<span style='font-family:verdana,sans-serif;line-height:150%;font-size:"& (100 + (i)) &"%;margin:10px;'><a title='" & Tags(objRS("tag_ID")).Count & "' alt='"&  Tags(objRS("tag_ID")).Count  &"' href='" & Tags(objRS("tag_ID")).Url &"'>" & Tags(objRS("tag_ID")).name & "</a></span> "
		j=j+1
		objRS.MoveNext
	Loop
End If
